...
# ╔═╡ 3846f41c-264f-47b9-acc4-3d2f3df26f91
using DifferentialEquations

# ╔═╡ 3381494f-52be-444b-8cdd-135ed29c762c
using CairoMakie

# ╔═╡ 0438ba6f-2374-4628-bf3d-0f41f7dceaf7
using PlutoUI

# ╔═╡ 3b0a0aee-c712-45a0-b608-039607c97c2b
md"""
# Interactivity examples
"""

# ╔═╡ 9559ff1d-9204-4be8-a987-a10a01cb3936
md"""
## "At any instant, the program state is completely described by the code you see."
Source: Pluto.jl documentation.
"""

# ╔═╡ 37659ad2-d56b-11ef-36e0-4b243fbff04a
n_people = 30

# ╔═╡ 58f3cd76-cbba-428e-9d78-7d08e89c419b
md"Number of people is $n_people"

# ╔═╡ 1dfa892b-daf4-4bee-95e0-f00072eae7a3
n_eyes = 2 * n_people

# ╔═╡ 5d1daf71-9181-4fbb-8b4d-5ca24b7265c6
md"Number of eyes is `n_people * 2 =` $n_people `* 2 =` $n_eyes"

# ╔═╡ 670891a1-dc2d-4cfd-8d11-af991c99577e
md"""
## PlutoUI
"""

# ╔═╡ 9b784f72-296d-4376-889a-6cab7ffd7330
"""
...
# Arguments
- `du` : Vector of differential elements. `du[1]` and `du[2]` correspond to `dx/dt` and `dy/dt` respectively.
- `u` : Vector variables. `u[1]` and `u[2]` correspond to `x` and `y` respectively.
- `p` : Vector of parameters. `p[1]`, `p[2]`, `p[3]` and `p[4]` correspond to `α`, `β`, `γ` and `δ`, respectively.
- `t` : Timestep.
"""
function lotka_volterra!(du, u, p, t)
	du[1] = p[1] * u[1] - p[2] * u[1] * u[2] 	# dx/dt = αx - βxy
	du[2] = -p[3] * u[2] + p[4] * u[1] * u[2] 		# dy/dt = -γy + δxy
end

# ╔═╡ 282a4750-767c-4737-9075-8a73f4d4dcc3
# Initial state of the system. u0[1] and u0[2] are the population of x and y at the initial timestep
u0 = [10, 10]

# ╔═╡ c4e55f95-872c-4964-b5d6-dc38b7674509
# Time interval
tspan = (0.0, 100.0)

# ╔═╡ 0ef9ab1e-8d2b-4aec-8f6f-ba72fdac1517
# Parameters 
# p = [0.1, 0.03, 0.1, 0.01]

# ╔═╡ 7fd4260c-e8d2-4062-ae48-13898109e3bd
md"""
Prey growth rate (α) - $(@bind p1 PlutoUI.Slider(0.05:0.01:0.15, default=0.05))

Predation rate (β) - $(@bind p2 PlutoUI.Slider(0.01:0.01:0.1, default=0.03))

Predator natural death rate (γ) -  $(@bind p3 PlutoUI.Slider(0.05:0.01:0.15, default=0.1))

Predators predation lead growth rate (δ) -  $(@bind p4 PlutoUI.Slider(0.01:0.01:0.05, default=0.01))
"""

# ╔═╡ 516afdb7-7e75-4bdf-be48-c32a0e13439d
p = [p1, p2, p3, p4]

# ╔═╡ 57f0036f-4a5e-4087-9135-882d271abffd
prob = ODEProblem(lotka_volterra!, u0, tspan, p)

# ╔═╡ f21f9e13-4bef-41a9-9c82-47501e614462
sol = solve(prob, Tsit5(), reltol = 1e-8, abstol = 1e-8)

# ╔═╡ c9e5e753-01fe-46b0-bf72-cac636c54581
fig, ax, sp = series(hcat(sol.u...), labels=["Prey", "Predators"])

# ╔═╡ 649daeb6-eace-4599-afcb-5e4f8179c474
axislegend(ax)

# ╔═╡ da97e162-0239-4b58-b7d1-f2b1281f093e
fig
...
manifest_format = "2.0"
project_hash = "d8ee5dee80f054caea829f1d46d93dbb087feb86"
